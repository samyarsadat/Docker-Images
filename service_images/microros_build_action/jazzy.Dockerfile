# Docker Images - MicroROS GitHub Build Action Image (ROS 2 Jazzy)
...
LABEL org.opencontainers.image.description="SSA Docker Images: MicroROS Build Action (ROS 2 Jazzy)"
