# Docker Images - ROS 2 Humble Image w/ Vulcanexus (Base - No GUI apps)
...
LABEL org.opencontainers.image.description="SSA Docker Images: ROS 2 Humble Image w/ Vulcanexus (Base - No GUI apps)"
