# Docker Images - ROS 2 Jazzy Image (Full Desktop w/ Gazebo)
...
LABEL org.opencontainers.image.description="SSA Docker Images: ROS 2 Jazzy Image (Full Desktop w/ Gazebo)"
