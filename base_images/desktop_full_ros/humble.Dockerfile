# Docker Images - ROS 2 Humble Image (Full Desktop w/ Gazebo)
...
LABEL org.opencontainers.image.description="SSA Docker Images: ROS 2 Humble Image (Full Desktop w/ Gazebo)"

# Install git, nano, curl, and Gazebo
RUN apt-get update \
    && apt-get install -y git nano curl ros-${ROS_DISTRO}-ros-gz \
