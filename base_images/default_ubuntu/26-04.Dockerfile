# Docker Images - Default Ubuntu Image (26.04 - Resolute Raccoon)
...
LABEL org.opencontainers.image.description="SSA Docker Images: Default Ubuntu Image (24.04 - Noble Numbat)"
